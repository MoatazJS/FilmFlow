...
export default function PopularPage() {
  ...
  useEffect(() => {
    const loadMoreMovies = async () => {
      setIsLoading(true);
      const newMovies = await fetchMovies("top_rated", page);
      setMovies((prev) => {
    ...
    <main className="min-h-screen flex flex-col bg-gradient-to-b from-black via-zinc-900 to-black text-gray-100 mt-10">
      ...
      <section className="text-center m-10">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          Explore the finest films ever made — ranked by audiences and critics
          alike. These top-rated masterpieces stand out for their storytelling,
          performances, and unforgettable cinematic impact.
        </p>
      </section>
