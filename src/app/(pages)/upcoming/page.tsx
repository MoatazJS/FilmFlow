...
export default function PopularPage() {
  ...
  useEffect(() => {
    const loadMoreMovies = async () => {
      setIsLoading(true);
      const newMovies = await fetchMovies("upcoming", page);
      setMovies((prev) => {
    ...
    <main className="min-h-screen flex flex-col bg-gradient-to-b from-black via-zinc-900 to-black text-gray-100 mt-10">
      ...
      <section className="text-center m-10">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          Stay ahead of the curve with the most anticipated upcoming releases.
          Get a sneak peek at the stories, adventures, and blockbusters that
          will soon light up the big screen.
        </p>
      </section>
